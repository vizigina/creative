function _await$1(t, e, r) {
  ...
  function _catch$1(t, e) {
    ...
    return r && r.then ? r.then(undefined, e) : r;
  }
  ...
  var t_formsApi__safeSetValue = function t(e, r, o) {
    var n, a = (o || {}).silent, i = undefined !== a && a;
    return e && e.value !== r && (e.value = r, i || e && e.dispatchEvent(new Event("change"))), r;
    ...
    return new Promise(function (t) {
      ...
      e.data.isAsync && !o ? e.element.addEventListener("inputReady", r, {once: true}) : r();
    });
    ...
    var m, f, _ = {element: e, data: r, getValue: s, onChange: u, focus: function t() {
      var e = e.querySelector('[name="' + a + '"]');
      e && e.focus();
    }, reset: function t() {
      var e = e.querySelector('[name="' + a + '"]'), o = r.defaultValue || "";
      t_formsApi__safeSetValue(e, o, {silent: true});
    }, onFieldReady: function t() {
      return t_formsApi__waitForFieldReadyState(_);
    }, _onChangeCallbacks: l, _uniqueOnChangeCallbacks: d};
    return e.t_field = _, _;
    ...
    return e.data.inputs = Array.from(e.element.querySelectorAll('[type="radio"]')), e.getValue = function () {
      ...
      e.data.inputs.forEach(function (e, o) {
        e.checked = !(!r || t !== o + 1);
      }), e.data.ownVariantInput && (e.data.ownVariantInput && e.data.ownVariantInput.dispatchEvent(new CustomEvent("reset")));
    }, e;
    ...
    return e.data.inputs = Array.from(e.element.querySelectorAll('[type="checkbox"]')), e.focus = function () {
      ...
      t_formsApi__safeSetValue(t, "", {silent: true}), e.data.ownVariantInput && (e.data.ownVariantInput && e.data.ownVariantInput.dispatchEvent(new CustomEvent("reset"))), e.data.inputs.forEach(function (t) {
    ...
    return r.onFieldReady = function () {
      return t_formsApi__waitForFieldReadyState(r).then(function () {
        return r.element.addEventListener("uwFileUploaded", function () {
          return r.element && r.element.dispatchEvent(new Event("change"));
      ...
      var t, o;
      return {value: Array.from(e.querySelectorAll('[name^="' + r.data.fieldName + '"]')).map(function (t) {
        return t_formsApi__safeValue(t);
      }).filter(Boolean).join("; ")};
    }, r.focus = function () {
      r.element.scrollIntoView({block: "center"});
    }, r.reset = function () {
      r.element && r.element.dispatchEvent(new CustomEvent("reset"));
    }, r;
    ...
    try {
      ...
      return r.onFieldReady = function () {
        ...
        var t = r.data.widget;
        t_formsApi__safeSetValue(t.inputElement, "", {silent: true}), t.reloadInfo();
      }, r;
    } catch (o) {
      console.log(o);
    }
    ...
    r.data.isContactMethod = true, r.data.typeInputName = n, r.data.idInputName = a;
    ...
    return r.focus = function () {
      ...
      r.element && r.element.dispatchEvent(new CustomEvent("reset"));
      var t = r.element.querySelector('.t-input[type="tel"]');
      t_formsApi__safeSetValue(t, "", {silent: true});
    }, r;
  }, t_formsApi__getSelectboxField = function t(e) {
    try {
      var r = t_formsApi__getTildaField(e), o = Number(r.data.defaultValue) || 0, n = r.element.querySelector('[name="' + r.data.fieldName + '"]');
      return r.reset = function () {
        var t;
        n && (n.options[o].selected = true);
      }, r;
    } catch (a) {
      console.error(a);
    }
    ...
    switch (r) {
      case FORMS_API_FIELD.VARIANTS:
        return o ? t_formsApi__ownVariantMixin(t_formsApi__checkboxesMixin(t_formsApi__getTildaField(e))) : t_formsApi__ownVariantMixin(t_formsApi__radioFieldMixin(t_formsApi__getTildaField(e)));
      case FORMS_API_FIELD.IMAGE_VARIANTS:
        return o ? t_formsApi__checkboxesMixin(t_formsApi__getTildaField(e)) : t_formsApi__radioFieldMixin(t_formsApi__getTildaField(e));
    ...
    return _catch$1(function () {
      ...
      return _await$1(Promise.allSettled(o), function (r) {
        ...
        }), (t.classList.contains("t-conditional-form") || t.querySelector(".t-conditional")) && e.dispatchEvent(new CustomEvent("sync-conditionals", {detail: {shouldPreventSubmit: false}}));
      });
    }, function (t) {
  ...
  var t_forms__updateAllVariables = _async(function (t) {
    return console.log("RESTART"), _continueIgnored(_catch(function () {
      var e = t.closest(".t-rec"), r = t_forms__getUsedVariables([e], {unique: true}), o;
      ...
      var n, a = r.filter(function (t) {
        ...
        return r ? _await(t_formsApi__initTildaField(r), function (r) {
          ...
          t_forms__updateInputVariable(e, t, r);
        }) : Promise.resolve();
      }));
  ...
  function t_forms__initEventPlaceholder(t) {
    var e = "focus", r = "blur";
    document.addEventListener || (e = "focusin", r = "focusout"), t_removeEventListener(t, e, t_forms__removePlaceholder), t_addEventListener(t, e, t_forms__removePlaceholder, true), t_removeEventListener(t, r, t_forms__addPlaceholder), t_addEventListener(t, r, t_forms__addPlaceholder, true);
  }
  ...
  function t_forms__moveFieldToNextRow(t) {
    ...
    t_forms__createArrWithAllRows(t, "t-input-group_inrow").forEach(function (t) {
      ...
      if (t.forEach(function (t) {
        t.classList.contains("t-input-group_inrow-last") && t.nextElementSibling && !t.nextElementSibling.classList.contains("t-input-group_inonerow") && (e = true);
      }), !e) {
  ...
  function t_forms__calculateFieldsWidthInJS(t, e) {
    var r = 15, o = {1: "t-input-block_width100", 2: "t-input-block_width50", 3: "t-input-block_width33", 4: "t-input-block_width25"};
  ...
  function t_forms__initBtnDblClick(t) {
    var e;
    if (((t = t || window.event).target || t.srcElement).closest('[type="submit"]')) return t.preventDefault ? t.preventDefault() : t.returnValue = false, false;
  }
    ...
    if (r) {
      ...
      if (o) {
        ...
        if (r.tildaSendingStatus && (i = r.tildaSendingStatus), !(i && i >= 1 || t_hasClass(r, "t706__submit_disable"))) {
          ...
          var s, l = document.getElementById("allrecords").getAttribute("data-tilda-formskey"), d = parseInt(o.getAttribute("data-formactiontype")), u;
          ...
          if (o.querySelector(".g-recaptcha") && grecaptcha) {
            ...
            if (_) grecaptcha.reset(_); else {
              var p = {size: "invisible", sitekey: o.getAttribute("data-tilda-captchakey"), callback: window.tildaForm.captchaCallback};
  ...
  function t_forms__submitEvent(t) {
    ...
    if (t.target && (e = t.target), e) {
      ...
      r && r.tildaSendingStatus && (o = r.tildaSendingStatus), o && "3" === o ? r.tildaSendingStatus = "" : (r && !t_hasClass(r, "t706__submit_disable") && r.click(), t.preventDefault ? t.preventDefault() : t.returnValue = false);
    }
  }
    ...
    Array.prototype.forEach.call(t, function (t) {
      ...
      if (e) {
        ...
        if (!window.tildaForm.isRecaptchaScriptInit) {
          ...
          window.tildaForm.isRecaptchaScriptInit = true, n.type = "text/javascript", n.src = "https://www.google.com/recaptcha/api.js?render=explicit", n.async = true, o.appendChild(n), o.insertAdjacentHTML("beforeend", '<style type="text/css">.js-send-form-success .grecaptcha-badge {display: none;}</style>');
        }
  ...
  window.t_forms__lang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.isInitEventsZB = {}, window.isInitEventsCustomMask = {}, window.initForms = {}, window.tildaForm = {versionLib: "02.001", endpoint: "https://script.google.com/macros/s/AKfycbwieKpPvNnWQLNMwyHwxJXWGQ0aiAJh64I57qb7YlKyIceFF8Z5JbV-zQuJGYBqb4pE/exec", isRecaptchaScriptInit: false, currentFormProccessing: false}, window.t_forms__clearForm = t_formsApi__clearForm, window.t_forms__updateAllVariables = t_forms__updateAllVariables, t_onReady(function () {
    ...
    if (o || n || a) {
      ...
      if (!document.head.querySelector('script[src*="' + i + '"]')) (s = document.createElement("script")).type = "text/javascript", s.src = "https://static.tildacdn." + t_forms__getRootZone() + "/js/" + i + ".min.js", s.onerror = function () {
    ...
    if (!window.tildaForm.currentFormProccessing || !window.tildaForm.currentFormProccessing.form) return false;
    window.tildaForm.send(window.tildaForm.currentFormProccessing.form, window.tildaForm.currentFormProccessing.btn, window.tildaForm.currentFormProccessing.formtype, window.tildaForm.currentFormProccessing.formskey), window.tildaForm.currentFormProccessing = false;
  }, window.tildaForm_customMasksLoad = function () {
    if (true !== window.isInitEventsCustomMask) {
    ...
    if (t.length && true !== window.isInitEventsCustomMask) return window.tildaForm_customMasksLoad(), void window.setTimeout(function () {
      window.tildaForm_initMasks();
    }, 100);
    true === window.isInitEventsCustomMask && Array.prototype.forEach.call(t, function (t) {
      t_asyncLoad(t);
    });
  }, t_onReady(function () {
    window.tildaForm_initMasks();
  }), window.tildaForm.validate = function (t) {
    for (var e = t_forms__getElement(t), r = e.querySelectorAll(".js-tilda-rule"), o = [], n = true, a, i = t_forms__getConditionCheckHandler(e).isHiddenByCondition, s = 0; s < r.length; s++) {
      var l = r[s];
      if (!i(l)) {
        var d = !!parseInt(l.getAttribute("data-tilda-req") || 0, 10), u = l.getAttribute("data-tilda-rule") || "none", c = "", m = "", f = l.getAttribute("data-tilda-rule-minlength") || 0, _ = l.getAttribute("data-tilda-rule-maxlength") || 0, p = {}, w = l.value, h = "", y = l.getAttribute("type"), g = l.getAttribute("name"), v = e.getAttribute("data-formcart");
        p.obj = l, p.type = [], w && w.length && (h = w.replace(/[\s\u0000—\u001F\u2000-\u200F\uFEFF\u2028-\u202F\u205F-\u206F]/gi, ""), w = w.trim()), f && (f = parseInt(f, 10)), _ && (_ = parseInt(_, 10));
        var b = !w.length && !h.length, A = "checkbox" === y || "radio" === y, E = e.querySelectorAll('[name="' + g + '"]:checked').length;
        if ((w.length && !A || A && E) && (n = false), d && (b || A && !E)) p.type.push("req"); else {
          switch (u) {
            case "email":
            ...
            case "url":
              ...
              break;
            case "phone":
              var F = l.getAttribute("data-tilda-mask"), x = "^[0-9()+-";
              F && (-1 !== F.indexOf("*") ? x += "a-zёа-я" : (-1 !== F.indexOf("a") && (x += "a-z"), -1 !== F.indexOf("а") && (x += "а-яё"))), x += "]+$", c = new RegExp(x, "gi"), (h.length && !h.match(c) || 1 == (m = h.replace(/[^0-9]+/g, "")).indexOf("000") || 1 == m.indexOf("111") && "9" != m.substring(0, 1) || 1 == m.indexOf("222") && "5" != m.substring(0, 1) || 1 == m.indexOf("333") || 1 == m.indexOf("444") || 1 == m.indexOf("555") && "0" != m.substring(0, 1) || 1 == m.indexOf("666") && "0" != m.substring(0, 1) || 1 == m.indexOf("8888") && "4" != m.substring(0, 1)) && p.type.push("phone");
              break;
            case "number":
              c = /^[0-9]+$/gi, h.length > 0 && !h.match(c) && p.type.push("number");
              break;
            case "date":
              t_onFuncLoad("t_datepicker__readDateFromInput", function () {
                var t = t_datepicker__readDateFromInput(l);
                h.length > 0 && !t_datepicker__isDateValid(t) && p.type.push("date");
              });
              break;
            case "time":
              c = /^[0-9]{2}[:\.][0-9]{2}$/gi, h.length > 0 && !h.match(c) && p.type.push("time");
              break;
            case "name":
            ...
            case "chosevalue":
              ...
              break;
            case "promocode":
              "y" !== v || !h.length || !window.tcart || window.tcart.promocode && window.tcart.prodamount_discountsum || p.type.push("promocode");
              break;
            case "deliveryreq":
    ...
    if ("y" === v) {
      var C = window.tcart_minorder > 0, I = window.tcart_mincntorder > 0, T, p, p;
      if (C) if ((window.tcart.prodamount_withdiscount > 0 ? window.tcart.prodamount_withdiscount : undefined !== window.tcart.prodamount_withdyndiscount && window.t_cart__discounts && window.t_cart__discounts.length > 0 ? window.tcart.prodamount_withdyndiscount : window.tcart.prodamount) < window.tcart_minorder) (p = {obj: {}, type: []}).type.push("minorder"), o.push(p);
      if (I && window.tcart.total < window.tcart_mincntorder) (p = {obj: {}, type: []}).type.push("minquantity"), o.push(p);
    }
    ...
    n || (n = ".blockinput");
    var a = "", i = false, s = true, l = "", d = "", u = "", c = "", m = document.getElementById("tilda-popup-for-error");
    m || (document.body.insertAdjacentHTML("beforeend", '<div id="tilda-popup-for-error" class="js-form-popup-errorbox tn-form__errorbox-popup" style="display: none;"> <div class="t-form__errorbox-text t-text t-text_xs"> error </div> <div class="tn-form__errorbox-close js-errorbox-close"> <div class="tn-form__errorbox-close-line tn-form__errorbox-close-line-left"></div> <div class="tn-form__errorbox-close-line tn-form__errorbox-close-line-right"></div> </div> </div>'), t_addEventListener(m = document.getElementById("tilda-popup-for-error"), "click", function (t) {
      var e, r;
      if (((t = t || window.event).target || t.srcElement).closest(".js-errorbox-close")) return t.preventDefault ? t.preventDefault() : t.returnValue = false, t_fadeOut(m), false;
    }));
    for (var f = 0; f < e.length; f++) if (e[f] && e[f].obj) {
      ...
      _ && (a = _.closest(n)), a && (d = a.querySelectorAll(".t-input-error"), t_addClass(a, "js-error-control-box"), d.length && (i = true));
      for (var p = 0; p < e[f].type.length; p++) {
        var w = e[f].type[p], h = t_forms__getMsg(w);
        u = "", (l = r.querySelector(".js-rule-error-" + w)) ? l.textContent && l.innerText || !h || -1 !== c.indexOf(h) ? (u = l.textContent || l.innerText, -1 === c.indexOf(u) && (c = c + '<p class="t-form__errorbox-item">' + u + "</p>")) : c = c + '<p class="t-form__errorbox-item">' + h + "</p>" : h && -1 === c.indexOf(h) && (c = c + '<p class="t-form__errorbox-item">' + h + "</p>"), i && (!u && t_forms__getMsg(w + "field") ? u = t_forms__getMsg(w + "field") : h && (u = h), u && a && (d = a.querySelectorAll(".t-input-error"), Array.prototype.forEach.call(d, function (t) {
    ...
    if (c) {
      ...
      if (Array.prototype.forEach.call(y, function (t) {
        ...
        if (g && g.length) {
          var v, b = '.t1093 .t-popup[data-tooltip-hook="' + g[g.length - 1] + '"]', A = document.querySelector(b), E = A ? getComputedStyle(A).zIndex : 0, F;
          E > 1e4 && (m.style.zIndex = E + 1);
        } else m.style.zIndex = "";
      }
      t_fadeIn(m);
    }
    function x(t) {
      ...
      if ("INPUT" === ((t = t || window.event).target || t.srcElement).tagName) {
        ...
        }), window.t_forms__errorTimerID && (window.clearTimeout(window.t_forms__errorTimerID), window.t_forms__errorTimerID = 0), window.isInitEventsZB[o] = true;
      }
    }
    if (window.t_forms__errorTimerID && window.clearTimeout(window.t_forms__errorTimerID), window.t_forms__errorTimerID = window.setTimeout(function () {
      ...
      document.addEventListener || (C = "focusin"), t_removeEventListener(S, C, x), t_addEventListener(S, C, x, true), t_removeEventListener(S, "change", x), t_addEventListener(S, "change", x, true);
    }
    return t_triggerEvent(r, "tildaform:aftererror"), true;
    ...
    for (var n, a = (r || {}).inputBoxSelector, i, s = undefined === a ? o.getAttribute("data-inputbox") || ".blockinput" : a, l = t_forms__createErrorFocusHash(), d = 0; d < e.length; d++) {
      var u = 0 === d, c = e[d];
      if (c && c.obj) {
        var m = c.obj;
        if ("none" === m && u) {
    ...
    return t_forms__scrollToInputWithError(e[0]), t_forms__showFormErrorsContainers(o), t_triggerEvent(o, "tildaform:aftererror"), true;
    ...
    if (!t_hasClass(t, "t-body_scroll-locked")) {
      var e = undefined !== window.pageYOffset ? window.pageYOffset : (document.documentElement || document.body.parentNode || document.body).scrollTop;
    ...
    t_addClass(o, "js-send-form-success"), t_forms__updateAllSystemVariables(o), t_forms__showSuccessbox(o).finally(function () {
      t_forms__handleSuccess(o, {successCallback: r, successUrl: e}), window.tildaForm.clearTCart(o), t_forms__clearFormInputs(o), t_forms__clearFormData(o);
    });
  }, window.tildaForm.clearTCart = function (t) {
    var e;
    if ("y" === t_forms__getElement(t).getAttribute("data-formcart")) {
      if (window.clearTCart = true, window.tcart = {amount: 0, currency: "", system: "", products: []}, window.tcart.system = "none", "object" == typeof localStorage) try {
    ...
    var form = t_forms__getElement(formNode), btnSubmit = t_forms__getElement(btnSubmitNode), allRecords = document.getElementById("allrecords"), pageId = allRecords.getAttribute("data-tilda-page-id"), projectId = allRecords.getAttribute("data-tilda-project-id"), formId = form.getAttribute("id"), dataFormCart = form.getAttribute("data-formcart");
    window.tildaForm.tildapayment = false, ("y" === dataFormCart || form.closest(".t706__orderform")) && window.tildaForm.addPaymentInfoToForm(form);
    try {
    ...
    if (inputItsGood || form.insertAdjacentHTML("beforeend", '<div style="position: absolute; left: -5000px; bottom: 0; display: none;"><input type="text" name="form-spec-comments" value="Its good" class="js-form-spec-comments" tabindex="-1" /></div>'), 2 === formType || !formType && formKey) {
      ...
      }), dataForm = arrFilter, window.tildaForm.tildapayment && window.tildaForm.tildapayment.products) dataForm.push({name: "tildapayment", value: JSON.stringify(window.tildaForm.tildapayment)}); else if (form.closest(".t706__orderform")) return false;
      window.tildaForm.tildamember && Object.keys(window.tildaForm.tildamember).length > 0 && dataForm.push({name: "tildamember", value: JSON.stringify(window.tildaForm.tildamember)}), dataForm = t_forms__formData(dataForm);
      var startRequest = Date.now();
      t_triggerEvent(form, "tildaform:beforesend");
      var xhr = new XMLHttpRequest;
      return xhr.open("POST", formUrl, true), xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"), xhr.setRequestHeader("Accept", "application/json, text/javascript, */*; q=0.01"), xhr.onreadystatechange = function () {
        if (4 === xhr.readyState) if (xhr.status >= 200 && xhr.status < 400) {
          ...
          if (data) {
            ...
            if ("object" == typeof objData) {
              ...
              try {
                if (objData && objData.redirectto && 3 == objData.redirectto.length && window.tildaForm.endpoint.substring(window.tildaForm.endpoint.length - 3) != objData.redirectto) return window.tildaForm.endpoint = "forms.tildaapi." + objData.redirectto, window.tildaForm.send(form, btnSubmit, formType, formKey), false;
              } catch (e) {
                console.log("error in dc action.");
              }
              if (objData && objData.error) {
                dataSuccessUrl = "", dataSuccessCallback = "";
                var msgContainers = t_forms__getErrorContainers(form, ""), errorBoxes = msgContainers.errorBoxes, allError = msgContainers.allError;
                ...
                if (window.Tilda && "function" == typeof window.Tilda.sendEventToStatistics) {
                  ...
                  try {
                    "undefined" != typeof ga && "tilda" !== window.mainTracker && ga("send", {hitType: "pageview", page: dataEventName, title: title}), window.mainMetrika && window[window.mainMetrika] && window[window.mainMetrika].hit(dataEventName, {title: title, referer: window.location.href});
                  } catch (error) {
                ...
                if ("y" === dataFormCart && null != (_objData$member = objData.member) && _objData$member.token) {
                  var _objData$member2, profileName = "tilda_members_profile" + projectId, memberInfo = {token: null == (_objData$member2 = objData.member) ? undefined : _objData$member2.token, projectid: projectId};
                  localStorage.setItem(profileName, JSON.stringify(memberInfo)), localStorage.setItem(profileName + "_timestamp", Math.floor(Date.now() / 1e3).toString()), t_onFuncLoad("t_bd__init", function () {
                    t_bd__init(), tcart__initAuthAndDelivery(true);
                  });
                }
                try {
                ...
                if (objData && objData.next && objData.next.type) return window.tildaForm.payment(form, objData.next), dataSuccessUrl = "", false;
          ...
          if (!xhr || 0 == xhr.status && tsDelta < 100) Array.prototype.forEach.call(allError, function (t) {
            ...
            if (xhr && (xhr.status >= 500 || 408 == xhr.status || 410 == xhr.status || 429 == xhr.status || "timeout" == xhr.statusText) && -1 !== window.tildaForm.endpoint.indexOf("forms.tilda")) return window.tildaForm.endpoint = "forms2.tildacdn.com", window.tildaForm.send(form, btnSubmit, formType, formKey), false;
    ...
    if ("y" === form.getAttribute("data-is-formajax")) {
      ...
      var xhr = new XMLHttpRequest;
      return xhr.open("POST", form.getAttribute("action"), true), xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"), xhr.setRequestHeader("Accept", "text/plain, */*; q=0.01"), xhr.onreadystatechange = function () {
        if (4 === xhr.readyState) if (xhr.status >= 200 && xhr.status < 400) {
          ...
          if (t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.tildaSendingStatus = "0", o = xhr.responseText) if ("{" == o.substring(0, 1)) {
            ...
            if ("object" == typeof n) if (n && n.message && "OK" !== n.message) t.innerHTML = n.message; else if (n && n.error) {
              ...
              return Array.prototype.forEach.call(s, function (t) {
                ...
                t.style.display = "block";
              }), t_addClass(form, "js-send-form-error"), t_triggerEvent(form, "tildaform:aftererror"), false;
            }
    ...
    return -1 == form.getAttribute("action").indexOf(window.tildaForm.endpoint) && (t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.tildaSendingStatus = "3", form.submit(), true);
  ...
  function checkVerifyTildaCaptcha(t) {
    if (-1 !== (t = t || window.event).origin.indexOf(window.tildaForm.endpoint)) {
      ...
      var o = t.data;
      if ("object" == typeof o && (o = JSON.stringify(o), Array.isArray(window.t_jserrors) || (window.t_jserrors = []), window.t_jserrors.push({message: "Recaptcha returned object, instead of string: " + o, filename: "tilda-form-1.0", lineno: 0, colno: 0})), e) {
  ...
  function t_forms__onSuccess(t) {
    var e = t_forms__getElement(t), r = e.closest(".r"), o = r.getAttribute("data-record-type"), n = e.querySelector(".t-form__inputsbox"), a = getComputedStyle(n, null), i = parseInt(a.paddingTop) || 0, s = parseInt(a.paddingBottom) || 0, l, d, u = n.clientHeight - (i + s) + (n.getBoundingClientRect().top + window.pageYOffset), c = e.querySelector(".t-form__successbox"), m = c ? c.getBoundingClientRect().top + window.pageYOffset : 0, f = 0, _ = window.innerHeight, p = document.body, w = document.documentElement, h = Math.max(p.scrollHeight, p.offsetHeight, w.clientHeight, w.scrollHeight, w.offsetHeight);
    if (121 == o) {
      var y = e.getAttribute("data-success-callback");
      y && (o = y.split("_onSuccess")[0].replace("t", ""));
    }
    var g = "t" + o + "__inputsbox_hidden", v = [702, 708, 862, 945, 1014, 1114], b = true;
    f = window.innerWidth > 960 ? m - 200 : m - 100;
    var A = document.querySelector(".t-tildalabel");
    if (m > window.scrollY || h - u < _ - 100) n.classList.add(g), _ > h && A && setTimeout(function () {
      t_fadeOut(A);
    }, 300); else {
      for (var E = 0; E < v.length; E++) if (v[E] == o) {
        b = false;
        break;
      }
    ...
    var F = e.getAttribute("data-success-url");
    if (F && setTimeout(function () {
      window.location.href = F;
    }, 500), 835 == o || 862 == o) {
      var x = r.querySelector(".t" + o + "__btn_prev"), S = r.querySelector(".t" + o + "__wrapper"), C = r.querySelector(".t" + o + "__quiz-form-wrapper");
  ...
  function t_forms__getConditionCheckHandler(t) {
    ...
    return {isHiddenByCondition: function t(r) {
  ...
  function t_forms__elementHasVariables(t) {
    var e;
    return /{{(form|tilda).([A-zА-я0-9_-]+)(?:=([^{}]+))?}}/g.test(t.textContent);
  }
  function t_forms__replaceVariablesWithPlaceholders(t) {
    ...
    return e.forEach(function (t) {
      t.innerHTML = t.innerHTML.replace(/{{(form|tilda).([A-zА-я0-9_-]+)(?:=([^{}]+))?}}/g, function (t, e, r, o) {
  ...
  function t_forms__findMatchingTextNodes(t, e) {
    for (var r = [], o = document.createTreeWalker(t, NodeFilter.SHOW_TEXT, {acceptNode: function t(r) {
  ...
  function t_forms__bindFormVariablesToPlaceholders(t, e) {
    return new Promise(function (r) {
      var o, n = t_forms__getUsedVariables(e, {unique: true}).map(function (r) {
        if ("tilda" === r.domain && Object.values(t_forms__getSystemVariables()).includes(r.name)) return e.forEach(function (e) {
        ...
        return o ? t_formsApi__initTildaField(o).then(function (o) {
          o.onChange(function () {
            return t_forms__updateInputVariable(t, r, o);
  ...
  function t_forms__updateAllSystemVariables(t) {
    ...
    t_forms__getUsedVariables([e], {unique: true}).filter(t_forms__isSystemVariable).forEach(function (t) {
  ...
  function t_forms__handleSuccess(form, options) {
    var _ref2 = options || {}, successUrl = _ref2.successUrl, _ref2$successCallback = _ref2.successCallback, successCallback = undefined === _ref2$successCallback ? "" : _ref2$successCallback, callback = (successCallback || "").replace("window.", "");
  ...
  function t_removeEventListener(t, e, r) {
    t.removeEventListener ? t.removeEventListener(e, r, false) : t.detachEvent && t_forms__htmlEvents["on" + e] ? t.detachEvent("on" + e, r) : t["on" + e] = null;
  }
  ...
  function t_serializeArray(t) {
    ...
    } else for (var l = r[a].options, d = 0; d < l.length; d++) l[d].selected && e.push({name: l[d].name, value: l[d].value});
    return e;
  }
  ...
  function t_triggerEvent(t, e) {
    var r;
    document.createEvent ? (r = document.createEvent("HTMLEvents")).initEvent(e, true, false) : document.createEventObject && ((r = document.createEventObject()).eventType = e), r.eventName = e, t.dispatchEvent ? t.dispatchEvent(r) : t.fireEvent ? t.fireEvent("on" + r.eventType, r) : t[e] ? t[e]() : t["on" + e] && t["on" + e]();
  }
